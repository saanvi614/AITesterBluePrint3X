...
2. Write test cases for the application **Swag Labs(`https://www.saucedemo.com/`)** covering **both functional and non-functional** requirements.
...
Test Steps: 1. Open https://www.saucedemo.com/  2. Enter valid email  3. Enter valid password  4. Click Login |
